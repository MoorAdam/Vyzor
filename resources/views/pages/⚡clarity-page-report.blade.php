...
>
    <div class="flex items-center justify-between">
        <div>
            <x-ui.heading level="h1" size="xl">{{ __('Page Report') }}</x-ui.heading>
            <x-ui.description class="mt-1">{{ __('Request an AI-generated report focused on a specific page of the current project.') }}</x-ui.description>
        </div>
